# Aula 4 - Nosso repertório para a FRTL 2024 (Noia)

## Overview

Vamos finalmente mostrar os códigos do nosso drone: Finite States Machine (FSM), como cada State funciona, Blackboard, as funções e a classe Drone. Vamos também falar sobre o Github: como commitar, como dar pull e push, como criar branches, como fazer merge, não commitar na main.
