...
Explicar a estrutura geral do eVTOL - hélices, motores brushless, step-motors, ESCs, aletas, nomes das partes do eVTOL. Qual a função de: Rasp Pi, PixHawk, sensores inerciais, motor servo. Apresentar o Armageddon e comparar com outros modelos de eVTOL.

Tópicos: Estrutura Geral; Sensores; Motores; modelos de eVTOL.
